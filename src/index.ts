...
export default async function main(argv: string[]): Promise<void> {
    try {
        ...
        program
            ...
            .addOption(new Option('-q, --quality <insider|stable|exploration>', 'quality of a published build to test (defaults to "insider"); "exploration" is a pre-release quality between "insider" and nightly builds').choices(['insider', 'stable', 'exploration']))
