...
export default async function main(argv: string[]): Promise<void> {
    try {
        ...
        interface Opts {
            ...
            commit?: string;
            version?: string;
            quality?: 'insider' | 'exploration' | 'stable';
            flavor?: string;
            good?: string;
            bad?: string;
            exclude?: string[];
        ...
        program
            ...
            .addOption(new Option('-q, --quality <insider|exploration|stable>', 'quality of a published build to test, defaults to "insider"').choices(['insider', 'exploration', 'stable']))
